...
<body>
  ...
  <main>
    <article>
      ...
      <section class="hero text-center" aria-label="home">

        <div class="hero-content">
          <h1 class="hero-h1">Mari Makan Minum <span>Kopi</span></h1>
          <p class="hero-p label-1">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nulla minus hic voluptatem est id doloribus eveniet obcaecati qui accusantium expedita laboriosam quos nemo officia, delectus, nisi culpa assumenda nostrum. Velit?</p>
        </div>
        ...
        <ul class="hero-slider" data-hero-slider>
          ...
          <li class="slider-item active" data-hero-slider-item>
            ...
            <div class="slider-bg">
              <img src="Media/hero-slider-1.jpg" width="1880" height="950" alt="" class="img-cover">
            </div>
          ...
          <li class="slider-item" data-hero-slider-item>
            ...
            <div class="slider-bg">
              <img src="Media/hero-slider-2.jpg" width="1880" height="950" alt="" class="img-cover">
            </div>
          ...
          <li class="slider-item" data-hero-slider-item>
            ...
            <div class="slider-bg">
              <img src="Media/hero-slider-3.jpg" width="1880" height="950" alt="" class="img-cover">
            </div>
